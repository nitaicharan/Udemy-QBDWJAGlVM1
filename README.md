...
![Udemy][udemy-shield]
![Java][java-shield]
![Quarkus][quarkus-shield]


<p align="center">:bangbang: Documentation available to access at: https://nitaicharan.github.io/Udemy-QBDWJAGlVM1 :bangbang:</p>
...
This project was part of the Udemy course "Quarkus Backend development with Java and GraalVM" by Dmytro Chaban.
...
### Certificate
This certificate above verifies that [Nitai Charan][udemy-url] successfully completed the course [Quarkus Backend development with Java and GraalVM][course-url] on ??/??/???? as taught by [Dmytro Chaban][instructor-url] on Udemy. The certificate indicates the entire course was completed as validated by the student.
...
```
- Get environment variables on https://dashboard.heroku.com/apps/Udemy-QBDWJAGlVM1/settings
...
<!-- ALIES README -->
[course-url]: https://udemy.com/course/quarkus-backend-development-java/
[instructor-url]: https://udemy.com/user/dmitry-chaban-2/
[certificate-url]: #
...
[quarkus-shield]:https://img.shields.io/badge/-Quarkus-white.svg?logo=quarkus&logoColor=white&colorB=4695EB